...
public class JImGui {
    ...
    public static float getScale() {
        ...
        // Special handling for 1920x1200
        if (Window.getWidth() == 1920 && Window.getHeight() == 1200) {
            // Adjust the scale factor slightly for this specific resolution
            // as it has a 16:10 aspect ratio instead of 16:9
            return scale * (16.0f / 10.0f) / (16.0f / 9.0f);
        }
        
        return scale;
    }
    
    // Apply scaling to a value with resolution awareness
